...
struct I18nCatalog {
    ...
    private let entries: [SupportedLanguage: [String: String]] = [
        .zhCN: [
            ...
            "settings.toolbarAutoHide": "工具栏自动隐藏",
            "settings.autoSaveEnabled": "对话自动保存",
            "settings.autoSaveInterval": "自动保存间隔",
            "settings.autoSaveIntervalValue": "%d 秒",
            ...
            "history.siteFilter": "网站",
            "history.timeFilter": "时间",
            "history.siteAll": "全部网站",
            "history.timeAll": "全部",
            "history.timeToday": "今天",
            "history.timeLast7": "近 7 天",
            "history.timeLast30": "近 30 天",
            "history.timeCustom": "自定义",
            "history.customStart": "开始",
            "history.customEnd": "结束",
            "history.codeOnly": "仅代码",
            "history.totalCount": "共 %d 条记录",
            "history.previewTitle": "详情预览",
            "history.previewSite": "网站:",
            "history.previewTime": "时间:",
            "history.previewUrl": "URL:",
            "history.previewPlaceholder": "请选择一条记录",
            "history.copy": "复制",
            "history.copySuccess": "已复制",
            "history.copyFail": "复制失败",
            "history.export": "导出",
            "history.exportConfirm": "选择文件夹",
            "history.exportSuccess": "导出完成",
            "history.delete": "删除",
            "history.deleteConfirm": "确认删除选中的记录？",
            "history.deleteConfirmAction": "删除",
            "history.deleteSuccess": "已删除",
            "common.close": "关闭",
            "common.cancel": "取消",
        ...
        .en: [
            ...
            "settings.toolbarAutoHide": "Toolbar auto-hide",
            "settings.autoSaveEnabled": "Auto-save conversations",
            "settings.autoSaveInterval": "Auto-save interval",
            "settings.autoSaveIntervalValue": "%ds",
            ...
            "history.siteFilter": "Site",
            "history.timeFilter": "Time",
            "history.siteAll": "All sites",
            "history.timeAll": "All",
            "history.timeToday": "Today",
            "history.timeLast7": "Last 7 days",
            "history.timeLast30": "Last 30 days",
            "history.timeCustom": "Custom",
            "history.customStart": "Start",
            "history.customEnd": "End",
            "history.codeOnly": "Code only",
            "history.totalCount": "%d records",
            "history.previewTitle": "Preview",
            "history.previewSite": "Site:",
            "history.previewTime": "Time:",
            "history.previewUrl": "URL:",
            "history.previewPlaceholder": "Select a record to preview",
            "history.copy": "Copy",
            "history.copySuccess": "Copied",
            "history.copyFail": "Copy failed",
            "history.export": "Export",
            "history.exportConfirm": "Choose Folder",
            "history.exportSuccess": "Export complete",
            "history.delete": "Delete",
            "history.deleteConfirm": "Delete selected records?",
        ...
        .ja: [
            ...
            "settings.toolbarAutoHide": "ツールバーを自動的に隠す",
            "settings.autoSaveEnabled": "会話を自動保存",
            "settings.autoSaveInterval": "自動保存間隔",
            "settings.autoSaveIntervalValue": "%d秒",
            ...
            "history.siteFilter": "サイト",
            "history.timeFilter": "期間",
            "history.siteAll": "すべてのサイト",
            "history.timeAll": "すべて",
            "history.timeToday": "今日",
            "history.timeLast7": "過去7日",
            "history.timeLast30": "過去30日",
            "history.timeCustom": "カスタム",
            "history.customStart": "開始",
            "history.customEnd": "終了",
            "history.codeOnly": "コードのみ",
            "history.totalCount": "合計 %d 件",
            "history.previewTitle": "詳細プレビュー",
            "history.previewSite": "サイト:",
            "history.previewTime": "時間:",
            "history.previewUrl": "URL:",
            "history.previewPlaceholder": "記録を選択してください",
            "history.copy": "コピー",
            "history.copySuccess": "コピーしました",
            "history.copyFail": "コピーに失敗しました",
            "history.export": "エクスポート",
            "history.exportConfirm": "フォルダを選択",
            "history.exportSuccess": "エクスポート完了",
            "history.delete": "削除",
            "history.deleteConfirm": "選択した記録を削除しますか？",
            "history.deleteConfirmAction": "削除",
            "history.deleteSuccess": "削除しました",
            "common.close": "閉じる",
            "common.cancel": "キャンセル",
        ...
        .ko: [
            ...
            "settings.toolbarAutoHide": "툴바 자동 숨김",
            "settings.autoSaveEnabled": "대화 자동 저장",
            "settings.autoSaveInterval": "자동 저장 간격",
            "settings.autoSaveIntervalValue": "%d초",
            ...
            "history.title": "기록",
            "history.close": "닫기",
            "history.searchPlaceholder": "검색...",
            "history.siteFilter": "사이트",
            "history.timeFilter": "기간",
            "history.siteAll": "모든 사이트",
            "history.timeAll": "전체",
            "history.timeToday": "오늘",
            "history.timeLast7": "최근 7일",
            "history.timeLast30": "최근 30일",
            "history.timeCustom": "사용자 지정",
            "history.customStart": "시작",
            "history.customEnd": "끝",
            "history.codeOnly": "코드만",
            "history.totalCount": "총 %d개",
            "history.previewTitle": "미리보기",
            "history.previewSite": "사이트:",
            "history.previewTime": "시간:",
            "history.previewUrl": "URL:",
            "history.previewPlaceholder": "기록을 선택하세요",
            "history.copy": "복사",
            "history.copySuccess": "복사됨",
            "history.copyFail": "복사 실패",
            "history.export": "내보내기",
            "history.exportConfirm": "폴더 선택",
            "history.exportSuccess": "내보내기 완료",
            "history.delete": "삭제",
            "history.deleteConfirm": "선택한 기록을 삭제할까요?",
            "history.deleteConfirmAction": "삭제",
        ...
        .es: [
            ...
            "settings.toolbarAutoHide": "Ocultar barra de herramientas automáticamente",
            "settings.autoSaveEnabled": "Guardar conversaciones automáticamente",
            "settings.autoSaveInterval": "Intervalo de guardado automático",
            "settings.autoSaveIntervalValue": "%ds",
            ...
            "history.searchPlaceholder": "Buscar...",
            "history.siteFilter": "Sitio",
            "history.timeFilter": "Fecha",
            "history.siteAll": "Todos los sitios",
            "history.timeAll": "Todo",
            "history.timeToday": "Hoy",
            "history.timeLast7": "Últimos 7 días",
            "history.timeLast30": "Últimos 30 días",
            "history.timeCustom": "Personalizado",
            "history.customStart": "Inicio",
            "history.customEnd": "Fin",
            "history.codeOnly": "Solo código",
            "history.totalCount": "%d registros",
            "history.previewTitle": "Vista previa",
            "history.previewSite": "Sitio:",
            "history.previewTime": "Hora:",
            "history.previewUrl": "URL:",
            "history.previewPlaceholder": "Selecciona un registro",
            "history.copy": "Copiar",
            "history.copySuccess": "Copiado",
            "history.copyFail": "Error al copiar",
            "history.export": "Exportar",
            "history.exportConfirm": "Elegir carpeta",
            "history.exportSuccess": "Exportación completa",
            "history.delete": "Eliminar",
            "history.deleteConfirm": "¿Eliminar los registros seleccionados?",
            "history.deleteConfirmAction": "Eliminar",
            "history.deleteSuccess": "Eliminado",
            "common.close": "Cerrar",
        ...
        .fr: [
            ...
            "settings.toolbarAutoHide": "Masquer automatiquement la barre d’outils",
            "settings.autoSaveEnabled": "Sauvegarde automatique des conversations",
            "settings.autoSaveInterval": "Intervalle de sauvegarde automatique",
            "settings.autoSaveIntervalValue": "%d s",
            ...
            "history.siteFilter": "Site",
            "history.timeFilter": "Période",
            "history.siteAll": "Tous les sites",
            "history.timeAll": "Tout",
            "history.timeToday": "Aujourd'hui",
            "history.timeLast7": "7 derniers jours",
            "history.timeLast30": "30 derniers jours",
            "history.timeCustom": "Personnalisé",
            "history.customStart": "Début",
            "history.customEnd": "Fin",
            "history.codeOnly": "Code uniquement",
            "history.totalCount": "%d enregistrements",
            "history.previewTitle": "Aperçu",
            "history.previewSite": "Site :",
            "history.previewTime": "Heure :",
            "history.previewUrl": "URL :",
            "history.previewPlaceholder": "Sélectionnez un enregistrement",
            "history.copy": "Copier",
            "history.copySuccess": "Copié",
            "history.copyFail": "Échec de la copie",
            "history.export": "Exporter",
            "history.exportConfirm": "Choisir un dossier",
            "history.exportSuccess": "Exportation terminée",
            "history.delete": "Supprimer",
            "history.deleteConfirm": "Supprimer les enregistrements sélectionnés ?",
            "history.deleteConfirmAction": "Supprimer",
            "history.deleteSuccess": "Supprimé",
            "common.close": "Fermer",

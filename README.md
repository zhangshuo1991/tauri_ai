...
3. Launch **AIHubApp** from Applications.

## Installation (Windows)
1. Run the Windows installer provided with your release.
2. Follow the setup wizard prompts.
3. Launch **AIHubApp** from the Start menu.

## System Requirements
- **macOS 15** or later
- Apple Silicon or Intel Mac
- **Windows 64-bit** (installer provided separately)

## Privacy & Security
- Configuration and settings are stored locally in your user profile.
- The app embeds web services via WebKit; data handling follows each service’s own policies.

## Support / Contact
- Issue tracker: Provide your preferred link or email and we’ll update this section.

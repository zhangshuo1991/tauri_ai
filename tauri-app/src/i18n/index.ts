...
const zhCN: Dict = {
  ...
  "top.split": "分屏",
  "home.eyebrow": "AI HUB",
  "home.title": "你的 AI 工作台",
  "home.subtitle": "在一个界面中切换与管理多个 AI 站点与会话。",
  "home.addSite": "添加站点",
  "home.settings": "设置",
  "home.tipsTitle": "使用提示",
  "home.tip1": "将常用站点置顶，随时一键直达。",
  "home.tip2": "新建标签可保留不同会话与上下文。",
  "home.tip3": "分屏适合对比回答或同步阅读资料。",
  "home.sectionPinned": "置顶站点",
  "home.sectionRecent": "最近使用",
  "home.emptyPinned": "还没有置顶站点",
  "home.emptyRecent": "最近暂无记录",
  "settings.title": "设置",
  "settings.subtitle": "个性化外观、布局与 AI 偏好",
  "settings.done": "完成",
  "settings.cancel": "取消",
...
const en: Dict = {
  ...
  "top.split": "Split",
  "home.eyebrow": "AI HUB",
  "home.title": "Your AI Workspace",
  "home.subtitle": "Switch and manage multiple AI sites and sessions in one place.",
  "home.addSite": "Add site",
  "home.settings": "Settings",
  "home.tipsTitle": "Tips",
  "home.tip1": "Pin your go-to sites for instant access.",
  "home.tip2": "Use new tabs to keep separate sessions and context.",
  "home.tip3": "Split view is perfect for comparing answers.",
  "home.sectionPinned": "Pinned",
  "home.sectionRecent": "Recent",
  "home.emptyPinned": "No pinned sites yet",
  "home.emptyRecent": "No recent activity",
  "settings.title": "Settings",
  "settings.subtitle": "Personalize appearance, layout, and AI preferences.",
  "settings.done": "Done",
...
const ja: Dict = {
  ...
  "top.split": "分割",
  "home.eyebrow": "AI HUB",
  "home.title": "AI ワークスペース",
  "home.subtitle": "複数の AI サイトとセッションを1つの画面で管理。",
  "home.addSite": "サイト追加",
  "home.settings": "設定",
  "home.tipsTitle": "使い方のヒント",
  "home.tip1": "よく使うサイトをピン留めしてすぐアクセス。",
  "home.tip2": "新しいタブで別セッションを保持。",
  "home.tip3": "分割表示で回答を比較。",
  "home.sectionPinned": "ピン留め",
  "home.sectionRecent": "最近",
  "home.emptyPinned": "ピン留めはまだありません",
  "home.emptyRecent": "最近の履歴はありません",
  "settings.title": "設定",
  "settings.subtitle": "外観・レイアウト・AI設定をまとめて調整。",
  "settings.done": "完了",
...
const ko: Dict = {
  ...
  "top.split": "분할",
  "home.eyebrow": "AI HUB",
  "home.title": "AI 워크스페이스",
  "home.subtitle": "여러 AI 사이트와 세션을 한 곳에서 관리하세요.",
  "home.addSite": "사이트 추가",
  "home.settings": "설정",
  "home.tipsTitle": "사용 팁",
  "home.tip1": "자주 쓰는 사이트를 고정해 빠르게 이동하세요.",
  "home.tip2": "새 탭으로 세션과 맥락을 분리할 수 있어요.",
  "home.tip3": "분할 보기로 답변을 비교하세요.",
  "home.sectionPinned": "고정",
  "home.sectionRecent": "최근",
  "home.emptyPinned": "아직 고정된 사이트가 없습니다",
  "home.emptyRecent": "최근 기록이 없습니다",
  "settings.title": "설정",
  "settings.subtitle": "외관, 레이아웃, AI 설정을 한 곳에서 조정하세요.",
  "settings.done": "완료",
  "settings.cancel": "취소",
...
const es: Dict = {
  ...
  "top.split": "Dividir",
  "home.eyebrow": "AI HUB",
  "home.title": "Tu espacio de IA",
  "home.subtitle": "Gestiona varios sitios y sesiones de IA en un solo lugar.",
  "home.addSite": "Añadir sitio",
  "home.settings": "Configuración",
  "home.tipsTitle": "Consejos",
  "home.tip1": "Fija tus sitios favoritos para acceder rápido.",
  "home.tip2": "Usa nuevas pestañas para separar sesiones y contexto.",
  "home.tip3": "La vista dividida es ideal para comparar respuestas.",
  "home.sectionPinned": "Fijados",
  "home.sectionRecent": "Recientes",
  "home.emptyPinned": "Aún no hay sitios fijados",
  "home.emptyRecent": "No hay actividad reciente",
  "settings.title": "Configuración",
  "settings.subtitle": "Personaliza apariencia, diseño y preferencias de IA.",
  "settings.done": "Listo",
...
const fr: Dict = {
  ...
  "top.split": "Scinder",
  "home.eyebrow": "AI HUB",
  "home.title": "Votre espace IA",
  "home.subtitle": "Gérez plusieurs sites et sessions IA au même endroit.",
  "home.addSite": "Ajouter un site",
  "home.settings": "Paramètres",
  "home.tipsTitle": "Conseils",
  "home.tip1": "Épinglez vos sites favoris pour y accéder vite.",
  "home.tip2": "Utilisez de nouveaux onglets pour séparer les sessions.",
  "home.tip3": "La vue scindée est idéale pour comparer des réponses.",
  "home.sectionPinned": "Épinglés",
  "home.sectionRecent": "Récents",
  "home.emptyPinned": "Aucun site épinglé",
  "home.emptyRecent": "Aucune activité récente",
  "settings.title": "Paramètres",
  "settings.subtitle": "Personnalisez l’apparence, la disposition et les préférences IA.",
